            ...
            <LoginBox :title="__('Privacy Policy and Services')"
                ...
                <div class="w-full">
                    <div class="w-full border rounded-md p-3 md:p-4 lg:p-5 xl:p-6 text-sm md:text-base">
                        ...
                        <div
                            class="h-32 md:h-40 lg:h-48 xl:h-56 overflow-y-auto border rounded p-2 md:p-3 lg:p-4 text-justify text-xs md:text-sm lg:text-base bg-white">
                        ...
                        <button :disabled="!checkPolicy" @click="handleSubmit" :class="[
