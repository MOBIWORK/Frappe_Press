...
def callback(code=None, state=None):
    ...
    if (state == cached_state) or (saas_app):
        ...
        return "Invalid state parameter. The session timed out. Please try again or contact  EOV Cloud support at https://frappecloud.com/support"
    ...
    if saas_app and cached_state:
        ...
        logo = frappe.db.get_value(
            "Saas Signup Generator", cached_state, "image_path")
        frappe.local.response.type = "redirect"
