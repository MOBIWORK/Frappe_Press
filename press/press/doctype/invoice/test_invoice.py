...
class TestInvoice(unittest.TestCase):
    ...
    def test_invoice_with_credits_less_than_total(self):
        ...
        self.assertEqual(self.team.get_balance_all(), 0)
        self.team.allocate_credit_amount(10, source="Free Credits")
        self.assertEqual(self.team.get_balance_all(), 10)
    ...
    def test_invoice_with_credits_more_than_total(self):
        ...
        self.assertEqual(self.team.get_balance_all(), 70)
    ...
    def test_invoice_credit_allocation(self):
        ...
        self.assertEqual(self.team.get_balance_all(), 1100)
        invoice.reload()
        ...
        self.assertEqual(self.team.get_balance_all(), 1100 - 600)
        self.assertEqual(invoice.amount_due, 0)
        self.assertEqual(invoice.applied_credits, 600)
        self.assertDictContainsSubset(
            {"amount": 100,
                "source": "Free Credits"}, invoice.credit_allocations[0].as_dict()
        )
        self.assertDictContainsSubset(
            {"amount": 500,
                "source": "Prepaid Credits"}, invoice.credit_allocations[1].as_dict()
        )
    ...
    def test_prepaid_credits(self):
        ...
        with open(
            ...
            "fixtures/stripe_payment_intent_succeeded_webhook.json", "r"
        ) as payload:
            doc = frappe._dict(
        ...
        self.assertEqual(self.team.get_balance_all(), 755.64)
    ...
    def test_negative_balance_case(self):
        try:
            ...
            with self.assertRaises(frappe.ValidationError) as err:
                invoice.finalize_invoice()
            self.assertTrue(
                "Not enough credits for this invoice" in str(err.exception))
    ...
    def test_negative_balance_allocation(self):
        try:
            ...
            self.assertEqual(team.get_balance_all(), 5)
    ...
    def test_settle_negative_balance(self):
        ...
        try:
            ...
            settling_transaction = team.allocate_credit_amount(
                200, source="Prepaid Credits")
            self.assertEqual(team.get_balance_all(), 100)
