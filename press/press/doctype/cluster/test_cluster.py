...
class TestCluster(unittest.TestCase):
    ...
    #     cluster = cluster or create_test_cluster(
...
#             name="Frankfurt", region="eu-central-1", public=True)
...
#             "Press Settings", "domain", root_domain.name)
#         frappe.db.set_single_value(
#             "Press Settings", "aws_access_key_id", "test")
#         frappe.db.set_single_value(
#             "Press Settings", "aws_secret_access_key", "test")
...
#         self.assertEqual(database_server_count_before +
#                          1, database_server_count_after)
#         self.assertEqual(proxy_server_count_before +
#                          1, proxy_server_count_after)
...
#         self.assertEqual(database_server_count_after,
#                          database_server_count_before + 1)
#         self.assertEqual(proxy_server_count_after,
#                          proxy_server_count_before + 1)

#     @mock_iam
#     # don't create vms/servers
...
#         )
#         self.assertEqual(cluster.aws_access_key_id,
#                          key_pairs["AccessKey"]["AccessKeyId"])
#         self.assertEqual(
