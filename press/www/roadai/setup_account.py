...
def get_context(context):
    ...
    context.billing_info = {
		"billing_name": account_request.first_name if account_request else "",
		"email_id": account_request.email if account_request else "",
		"phone": account_request.phone_number if account_request else "",
	}
    return context
